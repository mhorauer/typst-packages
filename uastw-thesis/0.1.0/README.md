...
Once rendered, the ([PDF](thesis.pdf)) contains usage examples as example content. More in-depth information is, of course, available via the [Typst Documentation](https://typst.app/docs/).
